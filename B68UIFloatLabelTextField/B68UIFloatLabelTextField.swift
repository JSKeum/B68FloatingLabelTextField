...
open class B68UIFloatLabelTextField: UITextField {
  ...
  */
  ...
  fileprivate func setupObservers() {
    NotificationCenter.default.addObserver(self, selector:#selector(B68UIFloatLabelTextField.textFieldTextDidChange(_:)), name: NSNotification.Name.UITextFieldTextDidChange, object: nil)
    NotificationCenter.default.addObserver(self, selector: "fontSizeDidChange:", name: NSNotification.Name.UIContentSizeCategoryDidChange, object: nil)
    NotificationCenter.default.addObserver(self, selector:#selector(B68UIFloatLabelTextField.textFieldTextDidBeginEditing(_:)), name: NSNotification.Name.UITextFieldTextDidBeginEditing, object: self)
    NotificationCenter.default.addObserver(self, selector:#selector(B68UIFloatLabelTextField.textFieldTextDidEndEditing(_:)), name: NSNotification.Name.UITextFieldTextDidEndEditing, object: self)
  }
  ...
  fileprivate func fontSizeDidChange (_ notification : Notification) {
    applyFonts()
